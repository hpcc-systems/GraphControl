...
:DOBUILD
msbuild /m /p:Configuration=%CONFIG_MODE% /nologo /noconsolelogger /fileLogger /flp:logfile=%BUILD_DIR%\GraphControlStatic64_%CONFIG_MODE%.txt /verbosity:quiet GraphControl.sln
