...
:DOBUILD
msbuild /m /p:Configuration=%CONFIG_MODE% /nologo /noconsolelogger /fl /flp:logfile=%BUILD_DIR%\GraphControl_%CONFIG_MODE%.txt;ErrorsOnly SIGN.vcxproj 
