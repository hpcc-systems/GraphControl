...
if ( WIN32 AND EXTERNALS_DIRECTORY )
    ...
    set ( FREETYPE_LIBRARY "${EXTERNALS_DIRECTORY}/ft248/freetype-2.4.8/objs/win32/vc2010/freetype248MT.lib" )
    set ( BOOST_INCLUDEDIR "${EXTERNALS_DIRECTORY}/Boost/include/boost-1_44" CACHE PATH "Boost headers folder" )
    set ( BOOST_LIBRARYDIR "${EXTERNALS_DIRECTORY}/Boost/windows-i386-vc100" CACHE PATH "Boost libraries folder" )
