...
:DOBUILD
msbuild /p:Configuration=%CONFIG_MODE% /nologo /noconsolelogger /fl /flp:logfile=%BUILD_DIR%\GraphControlStatic_3_10_%CONFIG_MODE%.txt;ErrorsOnly FireBreath.sln 
