...
namespace agg
{
    ...
    public:
        ...
        void        draw(CGContextRef context, int x, int y, double scale=1.0) const;
        void        blend(CGContextRef context, 
                          const Rect* device_rect=0, 
                          const Rect* bmp_rect=0) const;
        void        blend(CGContextRef context, int x, int y, double scale=1.0) const;
